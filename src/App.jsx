...
function App() {
  const [state, setState] = useState({
    ...
    currentSection: 0,
    options: [
      { name: "Académico", selected: false },
      { name: "Aula Virtual", selected: false },
      { name: "Ayudantias", selected: false },
      { name: "Consejerias", selected: false },
      { name: "Prácticas", selected: false },
      { name: "Certificados", selected: false },
      { name: "Citas Médicas", selected: false },
      { name: "Biblioteca Virtual", selected: false },
    ],
    answer: {
      0: "",
      1: "",
  ...
  const handleOptionSelection = (idx) => {
    let validateThree =
      state.options.filter((option) => option.selected).length < 3;
  ...
  return (
    <SectionSelector
      nextToGreetings={nextToGreetings}
      answers={state.answer}
      onChangeAnswer={onChangeAnswer}
      handleNextSection={handleNextSection}
      options={state.options}
      sectionNumber={state.currentSection}
      selectionHandler={handleOptionSelection}
      canNext={canNext}
        ...
        <div className="h-full flex-1 relative">
          <div className="h-full overflow-hidden">
            ...
            <div className="h-full grid lg:grid-cols-12">
              <div className="col-span-7 lg:py-12 flex flex-col justify-center">
                <div className="px-16">
                  <h1 className="text-start text-2xl text-gray-800 font-semibold">
                    Campus Connect - Encuesta Estudiantil
                  </h1>
                  <br />
                  <p className="text-start text-md text-gray-600">
                    ¡Tu voz cuenta! Participa en la Encuesta Estudiantil de
                    Campus Connect y ayúdanos a mejorar tu experiencia
                    académica.
                  </p>
                  <br />
                  <button
                    className="px-3 py-2 bg-gray-800 border rounded-md text-white text-lg hover:bg-gray-600"
              ...
              <div className="col-span-5 lg:flex lg:flex-col justify-center hidden">
                <div className="px-32">
                      ...
                      <div className="flex flex-row-reverse">
                        <nav className="IdseW">
                          ...
                          <button
                            ...
                            className={`ButtonWrapper-sc-__sc-1qu8p4z-0 hMriYH ${
                              canPrevious() ? "hover:bg-slate-600" : ""
                            }`}
      ...
      <div className="h-full relative flex flex-col gtebR">
        <div className="h-full flex-1 relative">
          <div className="h-full overflow-auto md:overflow-hidden">
            ...
            <div className="h-full lg:grid lg:grid-cols-12 lg:py-12 flex flex-col justify-center px-8 gap-4">
              <div className="mt-12 col-span-5 px-4 flex flex-col justify-center">
                <div className="">
                  <h1 className="text-start text-2xl text-gray-800 font-semibold">
                  ...
                  <br />
                  <p className="text-start text-md text-gray-600">
                    Tu feedback es fundamental para mejorar tu experiencia en
                    Campus Connect. ¡Gracias por ser parte de este proceso!
                  </p>
                  <br />
                </div>
              </div>
              <div className="col-span-7 lg:py-12 flex flex-col lg:justify-center">
                <div className="grid lg:grid-cols-2 gap-4">
                  <div className="col-span-2 lg:col-span-1">
                    <h1 className="text-start text-lg text-gray-800 mb-1">
                      Correo
                    </h1>
                    <div className="hdHAaO text-md">
                      <textarea
                        value={answers.email}
                        onInput={(e) => onChangeInput(e, "email")}
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <div className="hdHAaO text-md">
                      <textarea
                        ...
                        onInput={(e) => onChangeInput(e, "birth_year")}
                        className="auto-size-text-area"
                        placeholder="Escribe aquí tu respuesta..."
                        rows="1"
                      ></textarea>
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    <h1 className="text-start text-lg text-gray-800 mb-1">
                      Año de Ingreso a ESPOL
                    </h1>
                    <div className="hdHAaO text-md">
                      <textarea
                        value={answers.start_year}
                        onInput={(e) => onChangeInput(e, "start_year")}
                        className="auto-size-text-area"
                        placeholder="Escribe aquí tu respuesta..."
                        rows="1"
                      ></textarea>
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <div className="hdHAaO text-lg flex gap-4">
                      <div
                        className={`flex justify-between flex-row text-xs ${
                          answers.start_semester == "1S"
                            ? "border-2 font-bold"
                            : "border"
                        } border-gray-500 py-2 px-3 bg-gray-200 rounded-md hover:bg-gray-300 cursor-pointer`}
                        onClick={() =>
                          onChangeCategoricalOption("start_semester", "1S")
                        }
                      >
                      ...
                      <div
                        className={`flex justify-between flex-row text-xs ${
                          answers.start_semester == "2S"
                            ? "border-2 font-bold"
                            : "border"
                        } border-gray-500 py-2 px-3 bg-gray-200 rounded-md hover:bg-gray-300 cursor-pointer`}
                        onClick={() =>
                          onChangeCategoricalOption("start_semester", "2S")
                        }
                      >
                        <div className="">2S</div>
                      </div>
                    </div>
                  </div>

                  <div className="col-span-2 lg:col-span-1 order-6 lg:order-none">
                    <h1 className="text-start text-lg text-gray-800 mb-1">
                      Género
                    </h1>
                    <div className="hdHAaO text-lg flex gap-4">
                      <div
                        ...
                        onClick={() => onChangeCategoricalOption("gender", "M")}
                      >
                        <div className="">M</div>
                      </div>
                      <div
                        className={`flex justify-between flex-row text-xs ${
                          answers.gender == "F"
                            ? "border-2 font-bold"
                            : "border"
                        } border-gray-500 py-2 px-4 bg-gray-200 rounded-md hover:bg-gray-300 cursor-pointer`}
                        onClick={() => onChangeCategoricalOption("gender", "F")}
                      >
                        <div className="">F</div>
                      </div>
                      <div
                        ...
                        onClick={() =>
                          onChangeCategoricalOption("gender", "N/A")
                        }
                      >
                        <div className="">No especifico</div>
                      </div>
                    </div>
                  </div>
                  <div className="col-span-2 lg:col-span-1 order-7 lg:order-none">
                    <h1 className="text-start text-lg text-gray-800 mb-1">
                      ¿Eres de Guayaquil?
                    </h1>
                    <div className="hdHAaO text-lg flex gap-4">
                      <div
                        onClick={() =>
                          onChangeCategoricalOption("from_gye", true)
                        }
                        className={`flex justify-between flex-row text-xs ${
                          answers.from_gye ? "border-2 font-bold" : "border"
                        } border-gray-500 py-2 px-3 bg-gray-200 rounded-md hover:bg-gray-300 cursor-pointer`}
                      >
                        <div className="">Sí</div>
                      </div>
                      <div
                        onClick={() =>
                          onChangeCategoricalOption("from_gye", false)
                        }
                        className={`flex justify-between flex-row text-xs ${
                          !answers.from_gye ? "border-2 font-bold" : "border"
                        } border-gray-500 py-2 px-3 bg-gray-200 rounded-md hover:bg-gray-300 cursor-pointer`}
                  ...
                  <div className="col-span-2 lg:col-span-2 order-5 lg:order-none">
                    <h1 className="text-start text-lg text-gray-800 mb-1">
                      Carrera
                    </h1>
...
function SecondSection({
  ...
  const setClassName = (option) => {
    const classNames = [
      "flex justify-between flex-row text-lg lg:text-2xl border-gray-500 py-2 px-5 rounded-md",
    ];
    if (option.selected) {
            ...
            <div className="h-full flex flex-col items-center justify-center">
              <div className="p-8">
                <h1 className="text-xl lg:text-3xl text-gray-600">
                  ¿Cuál de los siguientes servicios en línea de ESPOL utilizas
                  con frecuencia?*
                </h1>
                <div className="lg:text-lg text-gray-500 mb-6">
                  Puedes escoger hasta 3
                </div>
                <div className="grid lg:grid-cols-3 gap-4 text-2xl text-gray-600">
                  {options.map((option, idx) => (
                    <div
                      key={idx}
                      className={setClassName(option)}
                    ...
                    >
                      ...
                      {option.selected && (
                        <div className="CheckboxContent-sc-__sc-1r651ck-1 lbQWmh order-last flex items-center">
                          <span
                            data-qa="icon-check-svg"
                            className="Boundary-sc-__sc-184gmm6-0 hnRbqA"
                          >
...
function ThirdSection({
  ...
  const createAnswer = (data) => {
    setLoading(true);
    fetch(
      "https://us-east-1.aws.data.mongodb-api.com/app/application-0-dtudt/endpoint/answer",
      {
            ...
            <div className="h-full flex flex-col items-center justify-center">
              <div className="px-8 text-start">
                <div className="iJgKPa">
                  <h1 className="text-start text-xl lg:text-3xl text-gray-600">
                    {questionMap[selectedOption].question}
                  </h1>
                  <div className="text-lg lg:text-xl text-gray-400">
                    {questionMap[selectedOption].hint}
                  </div>
                  <br />
                  <div className="hdHAaO text-xl lg:text-3xl">
                    <textarea
                      value={answers[(selectedOption - 3).toString()]}
                  ...
                  {selectedOption == 11 && (
                    <>
                      <br />
                      <button
                        className={`inline-flex items-center px-5 py-3 border rounded-md text-white text-2xl ${
                          loading
                            ? "bg-gray-600"
...
function Dropdown({ onChangeCareer, answers }) {
    ...
    switch (actionState) {
      case 0:
        return (
          <button
            tabIndex="0"
            aria-controls="dropdown-1a2a59b1-5621-4d1a-a71f-eca68f429bcc-Yo6V3WL6w9YzLcKD-options-list"
            aria-expanded="false"
            aria-label="Mostrar opciones"
            className="IconWrapperRoot-sc-__sc-1w8q90m-4 jILXOM"
          >
  ...
  return (
    <div className="relative">
      ...
      <div className="">
        <div className="">
          <ul role="listbox" className="dJkqrm text-sm">
            {state.actionIcon != 0 &&
              state.filteredOptions &&
              state.filteredOptions.map((option, idx) => (
                <li
                  key={idx}
                  className="jCeoNW hover:bg-gray-100"
                  role="option"
                  onClick={() => autoCompleteOption(idx)}
                >
                  <div
                    data-qa="option-0-0-readable-element"
                    className="ChoiceContent-sc-__sc-1r651ck-0 njCeoNW"
                  >
                    <span className="A11yVisuallyHidden-sc-__sc-nyquty-0 ">
                      {option}
                    </span>
                  </div>
                </li>
              ...
              <div className="col-span-2 lg:py-12 flex flex-col justify-center">
                <div className="lg:px-64 px-12 text-center">
                  ...
                  <p className="text-xl text-gray-600">
                    Tu opinión es esencial para nosotros y nos ayudará a mejorar
                    Campus Connect. ¡Apreciamos tu tiempo y contribución a
